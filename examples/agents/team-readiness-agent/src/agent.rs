...
static OUTPUT: &[u8] = br#"{"readiness_result_id":"readiness-expedition-objective-001","objective_id":"expedition-objective-001","status":"ready","reasons":["team profile satisfies baseline expedition requirements"],"required_actions":[],"readiness_result":{"readiness_result_id":"readiness-expedition-objective-001","objective_id":"expedition-objective-001","status":"ready","reasons":["team profile satisfies baseline expedition requirements"],"required_actions":[]}}"#;
