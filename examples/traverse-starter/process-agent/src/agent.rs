...
static OUTPUT: &[u8] = br#"{"title":"Review Traverse starter app registration","tags":["review","traverse","starter"],"noteType":"project","suggestedNextAction":"expand","status":"complete"}"#;
