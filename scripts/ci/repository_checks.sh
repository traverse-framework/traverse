...
required_files=(
  ...
  "examples/decide-state-transition/NOTES.md"
  "examples/decide-state-transition/manifest.json"
  "examples/decide-state-transition/contract.json"
  "examples/decide-state-transition/build-fixture.sh"
  "examples/decide-state-transition/src/agent.rs"
  "examples/decide-state-transition/artifacts/decide-state-transition.wasm"
  "examples/decide-state-transition/docs/lifecycle-and-approval-policy-v1.2.md"
  "examples/decide-state-transition/runtime-requests/hp01-low-value-allow.json"
  "examples/decide-state-transition/runtime-requests/hp02-manager-needs-finance.json"
  "examples/decide-state-transition/runtime-requests/hp03-finance-manager-approve.json"
  "examples/decide-state-transition/runtime-requests/hp04-query-next-states.json"
  "examples/decide-state-transition/runtime-requests/hp05-cancel-within-window.json"
  "examples/decide-state-transition/runtime-requests/hp06-priority-escalate.json"
  "examples/decide-state-transition/runtime-requests/up01-illegal-jump-deny.json"
  "examples/decide-state-transition/runtime-requests/up02-insufficient-role.json"
  "examples/decide-state-transition/runtime-requests/up03-missing-amount.json"
  "examples/decide-state-transition/runtime-requests/up04-cancel-window-closed.json"
  "examples/decide-state-transition/runtime-requests/up05-open-children-block.json"
  "examples/decide-state-transition/runtime-requests/up06-no-roles.json"
  "examples/decide-state-transition/runtime-requests/up07-unknown-entity.json"
  "examples/decide-state-transition/runtime-requests/up08-partial-approvals.json"
  "examples/decide-state-transition/runtime-requests/hp-high-value-requires-approval.json"
  "examples/decide-state-transition/workflows/decide-state-transition/workflow.json"
  ...
  "scripts/ci/core_select_items_for_followup_example_smoke.sh"
  "scripts/ci/core_aggregate_team_action_health_example_smoke.sh"
  "scripts/ci/core_extract_action_items_example_smoke.sh"
  "scripts/ci/core_generate_nudge_message_example_smoke.sh"
  "scripts/ci/core_calculate_price_example_smoke.sh"
  "scripts/ci/core_normalize_participants_example_smoke.sh"
  "scripts/ci/core_calculate_deadline_pressure_example_smoke.sh"
  "scripts/ci/core_record_nudge_event_example_smoke.sh"
  "scripts/ci/core_evaluate_completion_quality_example_smoke.sh"
  "scripts/ci/core_notify_stakeholders_example_smoke.sh"
  "scripts/ci/core_decide_escalation_example_smoke.sh"
  ...
  "scripts/ci/mcp_stdio_server_mode_b_smoke.sh"
...
grep -q "bash scripts/ci/mcp_stdio_server_mode_b_smoke.sh" docs/mcp-stdio-server.md
grep -q "prepare-cache" docs/mcp-stdio-server.md
grep -q "docs/mcp-mode-b-release-evidence.md" docs/mcp-stdio-server.md
grep -q "bash scripts/ci/mcp_stdio_server_mode_b_smoke.sh" docs/mcp-mode-b-release-evidence.md
grep -q "docs/mcp-stdio-server.md" docs/mcp-mode-b-release-evidence.md
grep -q "traverse-mcp prepare-cache" docs/mcp-mode-b-release-evidence.md
grep -q "render_execution_report" docs/mcp-stdio-server.md
